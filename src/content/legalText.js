    ...
    },
    {
      ...
      blocks: [
        [
          ...
          "**CredentialDOMD support, only if you allow it.** In Settings you can allow support to view your account for 24 hours, and end that at any time. While it is allowed, the service administrator can open a read-only view of your account, as you see it, for up to 15 minutes at a time and only after entering a reason. Nothing can be added, changed, deleted, sent or shared from that view. Passport and travel IDs, tax, invoice, expense and deduction records, contract rates, portal logins and Protected Identity are never shown, and files are opened one at a time. Each view and each file opened is logged with the reason, and you can read that log in Settings.",
