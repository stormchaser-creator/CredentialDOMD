...
${degreeType === "DO" ? `    "State Medical License (DO)", "State Medical License (MD-equiv)", "DEA Registration", "State Controlled Substance", "Board Certification (AOA)", "Board Certification (ABMS)", "COMLEX", "USMLE", "BLS Certification", "ACLS Certification", "ATLS Certification", "Fluoroscopy Permit", "Laser Safety Certificate", "Certification (course / device training)", "Other"` : `    "State Medical License", "DEA Registration", "State Controlled Substance", "Board Certification (ABMS)", "ECFMG Certificate", "USMLE", "BLS Certification", "ACLS Certification", "ATLS Certification", "Fluoroscopy Permit", "Laser Safety Certificate", "Certification (course / device training)", "Other"`}
- "cme": CME certificate, continuing education credit, conference attendance — ONLY use this type if the document contains EXPLICIT credit-designation language (e.g. "designates this activity for a maximum of X AMA PRA Category 1 Credit(s)", an AOA Category 1-A/1-B/2-A/2-B statement, or an equivalent accredited CME/CE credit-hour statement). A vendor/device/procedure training or course-completion certificate that has NO credit-hour designation statement is "license" with type "Certification (course / device training)", NOT "cme" — do not classify as "cme" just because the document looks like a certificate or award.
