...
// The gate itself lives in identifierGate.js so the support view applies the
// very same rule; it is re-exported here for every existing caller.
export { identifierReason };
