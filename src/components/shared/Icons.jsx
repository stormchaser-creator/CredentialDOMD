...
// Written standalone rather than through svg(): that helper hardcodes
// fill="none", so a filled star built on it would be pixel identical to an
// empty one and the only signal left would be colour.
export const StarIcon = memo(({ filled = false, size = 16 }) => (
