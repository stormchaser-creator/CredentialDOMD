...
export default function ApplicationRecordsPaused({ section, count = 0, theme: T }) {
  return <section style={{ padding: 20, borderRadius: 12, border: `1px solid ${T.border}`, background: T.card, color: T.text }}>
    ...
    <p style={{ color: T.textMuted, lineHeight: 1.6 }}>A full JSON backup includes these records, but the app cannot restore them yet. Keep the backup private. Saved answers, explanations and notes are plain text.</p>
  </section>;
}
