...
export const CME_PROVIDERS = [
  ...
  },
  {
    ...
    description: "Free 1-hour buprenorphine mini course from the American Society of Addiction Medicine. Counts toward (but does not alone satisfy) the 8-hour DEA MATE Act requirement.",
    stateSpecific: false,
    stateSpecificNote: null,
    dualAccredited: false,
  ...
  // ─── NEUROSURGERY / DO-NATIVE PROVIDERS ─────────────────────────────
  {
    ...
    accreditation: ["AMA PRA Category 1"],
    accreditedBy: "ACCME (AANS)",
    topics: ["Patient Safety", "Pain Management"],
    specialty: "Neurosurgery",
    description: "American Association of Neurological Surgeons online learning — neurosurgery-specific CME including operative techniques, guidelines reviews, and annual meeting content.",
    stateSpecific: false, stateSpecificNote: null, dualAccredited: false,
    format: ["Online modules", "Webinars"],
  },
  {
    id: "cnsSans",
    ...
    accreditation: ["AMA PRA Category 1"],
    accreditedBy: "ACCME (Congress of Neurological Surgeons)",
    topics: ["Patient Safety"],
    specialty: "Neurosurgery",
    description: "The standard neurosurgery self-assessment question banks — widely used for ABNS Continuous Certification and board review, with Category 1 credit.",
    stateSpecific: false, stateSpecificNote: null, dualAccredited: false,
    format: ["Question bank", "Self-paced"],
  },
  {
    id: "jnsCme",
    name: "Journal of Neurosurgery CME",
    url: "https://thejns.org/page/cme",
    pricing: "paid",
    pricingNote: "Included with many AANS memberships",
    accreditation: ["AMA PRA Category 1"],
    accreditedBy: "ACCME (AANS)",
    topics: [],
    specialty: "Neurosurgery",
    description: "Article-based CME from the Journal of Neurosurgery — earn Category 1 credit for reading and testing on current neurosurgical literature.",
    stateSpecific: false, stateSpecificNote: null, dualAccredited: false,
    format: ["Journal CME"],
  },
  {
    ...
    accreditedBy: "AOA",
    topics: ["Ethics", "Pain Management", "Opioid Prescribing"],
    description: "The AOA's own education platform — one of the few reliable online sources of AOA Category 1-A and 1-B credit for DOs who need osteopathic-specific hours.",
    stateSpecific: false, stateSpecificNote: null, dualAccredited: true,
    format: ["Online modules", "Webinars"],
  },
