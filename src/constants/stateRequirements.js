...
export const STATE_REQS = {
  ...
  AL: { total: 25, cycle: 1, cat1min: 25, cat1note: "All AMA PRA Cat 1", topics: [
    ...
    { topic: "Ethics", hours: 0, note: "Board-designated professional boundaries course (one-time; existing licensees by 12/31/2025, new licensees within 12 months of license issue; residents/fellows on limited license exempt)", period: "lifetime" },
  ...
  CA: { md: { total: 50, cycle: 2, cat1min: 50, cat1note: "All Cat 1 approved", topics: [
    { topic: "Pain Management", hours: 12.0, note: "One-time 12 hrs pain management/terminally ill (by 2nd renewal)", period: "lifetime" },
    ...
    { topic: "Pain Management", hours: 12.0, note: "One-time 12 hrs pain management/terminally ill, within 4 yrs of licensure or by 2nd renewal, whichever first; pathology and radiology exempt", period: "lifetime" },
