...
//
// PER-TOPIC provenance: a topic may carry its own `cite` and `url`. One
// `sourceUrl` per rule set is not enough to verify a single line, because a
// state's topics rarely share one authority: California's 50-hour total is
// 16 CCR 1336 while its 12-hour pain-management mandate is B&P 2190.5, and a
// physician reading "12 hrs Pain Management" was being pointed at a citation
// that does not govern that line. A topic without `cite`/`url` inherits the
// rule set's `source` and `sourceUrl`, and the UI says the link is the board's
// general page rather than the rule itself. Do not invent a URL: leave it to
// inherit when the primary source was not actually loaded.
//
// PERIODICITY is load-bearing, not cosmetic. A topic with no `period` is
// demanded EVERY renewal cycle. Several rules that the notes already described
// as one-time or multi-year carried no `period`, so the engine re-demanded
// them every cycle (Louisiana's one-time 3-hr CDS course, on a 1-year cycle,
// was being asked for annually). When adding a topic whose note says
// "one-time", "before first renewal", or "every N years", encode it.
// 2026-08-28 pass: periodicity + per-topic citations across the jurisdictions
// listed in docs/CME-RULES-CHANGELOG-2026-08.md. `verified` months were left
// as they stood except where this pass loaded the source itself.
...
export const STATE_REQS = {
  ...
  AL: { total: 25, cycle: 1, cat1min: 25, cat1note: "All AMA PRA Cat 1", topics: [
    { topic: "Controlled Substances", hours: 2.0, note: "2 hrs controlled substance prescribing every 2 yrs (ACSC holders). Alabama's CME cycle is 1 year, so this is not owed every cycle.", period: { years: 2 }, cite: "Ala. Admin. Code r. 540-X-4-.09(8)" },
    { topic: "Ethics", hours: 2.0, note: "Board-designated professional boundaries course, one-time. ALBME designates a 2-hour on-demand course, Navigating Professional Boundaries in Medicine. Existing licensees by 12/31/2025, new licensees within 12 months of license issue; residents/fellows on limited license exempt.", period: "lifetime", cite: "Alabama Board of Medical Examiners, CME requirement" },
  ], notes: "2 hrs controlled substance prescribing every 2 yrs (ACSC holders); Board-designated professional boundaries course (one-time; existing licensees by 12/31/2025, new licensees within 12 months of license issue; residents/fellows on limited license exempt). ALBME designates a 2-hr on-demand course. The controlled substance hours are due every 2 yrs, not every 1-yr cycle.", rollover: "No", moc: "ABMS cert/MoC accepted as equivalent", source: "Ala. Admin. Code r. 540-X-14-.02; r. 540-X-4-.09(8) (controlled substance CME)", verified: "2026-08", sourceUrl: "https://www.albme.gov/resources/licensees/continuing-medical-education/licensure-cme-requirement" },
  AR: { total: 20, cycle: 1, cat1min: 10, cat1note: "50% must be Cat 1 in primary practice area", topics: [
    ...
    { topic: "Controlled Substances", hours: 3.0, note: "one-time 3 hrs prescribing ed (first 2 yrs)", period: "lifetime" },
  ...
  ], notes: "3 hrs opioid/SUD/addiction (DEA holders)", rollover: "No", moc: "No", source: "Ariz. Admin. Code R4-16-102", verified: "2026-08", sourceUrl: "https://www.law.cornell.edu/regulations/arizona/Ariz-Admin-Code-SS-R4-16-102" }, do: { total: 40, cycle: 2, cat1min: 24, cat1note: "24 hrs AOA Cat 1-A; max 16 hrs AMA Cat 1", cat1Accepted: ["AOA Category 1-A"], topics: [
    { topic: "Opioid Prescribing", hours: 3.0, note: "3 hrs opioid/SUD/addiction (DEA holders)" },
  ], notes: "3 hrs opioid/SUD/addiction (DEA holders); the 24-hr minimum must be AOA Cat 1-A. Up to 16 of the 40 total may be AMA PRA Cat 1; that total-composition cap is not enforced by the compliance engine.", rollover: "No", moc: "No", source: "Ariz. Admin. Code R4-22-207", verified: "2026-08", sourceUrl: "https://www.law.cornell.edu/regulations/arizona/Ariz-Admin-Code-SS-R4-16-102" } },
  // CA pain management (B&P 2190.5), rechecked 2026-08-28: NOT repealed, no
  // sunset. leginfo shows the section operative, last amended by SB 1109 (Stats.
  // 2018, Ch. 693, Sec. 3, eff. 2019-01-01); MBC and OMBC both still publish it;
  // FSMB's Aug 2026 board-by-board overview lists it for CA-M and CA-O; no bill
  // in the 2025-26 session touches it. The "completed by December 31, 2006"
  // phrase in 2190.5(a)(1) is a lapsed transition date for physicians already
  // licensed in 2002, not an expiry: the operative rule is a rolling obligation
  // on every new licensee. It is one-time, which is what `period: "lifetime"`
  // encodes, so the app has never demanded these 12 hours twice.
  CA: { md: { total: 50, cycle: 2, cat1min: 50, cat1note: "All Cat 1 approved", topics: [
    { topic: "Pain Management", hours: 12.0, note: "One-time 12 hrs pain management and treatment of terminally ill and dying patients, due within 4 yrs of initial licensure or by the 2nd renewal, whichever comes first. Pathology and radiology specialists are exempt (2190.5(c)). For physicians licensed on or after Jan 1, 2019 the course must also cover risks of addiction associated with Schedule II drugs. Alternative: a one-time 12 credit-hr course in treatment and management of opiate-dependent patients, including 8 hrs buprenorphine training, satisfies this instead (BPC 2190.6); physicians qualified under the federal CARA of 2016 are deemed compliant.", period: "lifetime", cite: "Cal. Bus. & Prof. Code \u00a7 2190.5; alternative at \u00a7 2190.6", url: "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=BPC&sectionNum=2190.5" },
    {
      topic: "Geriatric Medicine", hours: 10,
      note: "For general internists and family physicians with more than 25% of patients aged 65 or older: 20% of the mandatory 50-hour cycle is 10 hours in geriatric medicine, care of older patients, or special care needs of patients with dementia. This is not 20% of all hours logged. A topic tag helps track credits; it does not verify course content or board acceptance.",
      cite: "Medical Board of California, Required CME on Geriatrics for General Internists and Family Physicians",
      checkedOn: "2026-09-20", acceptedCategories: ["AMA PRA Category 1"],
      condition: {
        field: "California geriatric CME applies",
        question: "Are you a general internist or family physician AND are more than 25% of your patients aged 65 or older?",
        description: "Both conditions must be true: you are a general internist or family physician, and strictly more than 25% of your patients are aged 65 or older. Exactly 25% does not meet this threshold. Select your answer; the app does not infer it from your specialty, name, or CME records.",
      },
    },
    { topic: "Implicit Bias", hours: 0, informational: true, note: "AB 241 addresses CME course curriculum and accrediting entities, with exceptions for non-patient-care courses and out-of-state providers. It does not set a separate personal implicit-bias hour target or checklist. Review the course provider's documentation; an app topic tag does not verify its curriculum.", cite: "Cal. Bus. & Prof. Code \u00a7 2190.1(d) (AB 241)", url: "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=BPC&sectionNum=2190.1", checkedOn: "2026-09-20" },
  ], notes: "One-time 12 hrs pain management/treatment of terminally ill and dying patients (within 4 yrs of initial licensure or by the 2nd renewal, whichever comes first; pathology and radiology exempt; a one-time 12-hr opiate-dependence course under BPC 2190.6 is an accepted alternative); geriatrics if >25% patients 65+; implicit bias is a curriculum requirement on CME providers under AB 241, not physician hours", rollover: "No", moc: "ABMS cert/recert = 4 yrs (100 hrs) credit", source: "Cal. Code Reg. tit. 16, \u00a7 1336 (50 hrs biennially); Cal. Bus. & Prof. Code \u00a7 2190.5 (pain management); \u00a7 2190.1 (AB 241)", verified: "2026-08", sourceUrl: "https://www.mbc.ca.gov/Licensing/Physicians-and-Surgeons/Renew/Current-Status/Continuing-Medical-Education.aspx" }, do: { total: 50, cycle: 2, cat1min: 20, cat1note: "20 hrs AOA Cat 1A or 1B", cat1Accepted: ["AOA Category 1-A", "AOA Category 1-B"], topics: [
    { topic: "Pain Management", hours: 12.0, note: "One-time 12 hrs pain management and treatment of terminally ill and dying patients, within 4 yrs of licensure or by the 2nd renewal, whichever comes first; pathology and radiology specialists exempt. Alternative: a one-time 12 credit-hr course in treatment and management of opiate-dependent patients, including 8 hrs buprenorphine training, satisfies this instead (BPC 2190.6).", period: "lifetime", cite: "Cal. Bus. & Prof. Code \u00a7 2190.5; alternative at \u00a7 2190.6", url: "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=BPC&sectionNum=2190.5" },
    { topic: "Substance Use Disorders", hours: 1.0, note: "Min 1 hr on addiction to Schedule II drugs or opioids, due every renewal cycle. OMBC draws the contrast explicitly: unlike the one-time mandates, this is a condition of every renewal. It may also count toward the one-time 12-hr pain management course if taken during the cycle in which that course is due.", cite: "Cal. Bus. & Prof. Code \u00a7 2454.5(d) (SB 1109); OMBC CME document eff. 2025-10-01" },
    {
      topic: "Geriatric Medicine", hours: 10,
      note: "For general internists and family physicians with more than 25% of patients aged 65 or older: 20% of the mandatory 50-hour cycle is 10 hours in geriatric medicine, care of older patients, or special care needs of patients with dementia. This is not 20% of all hours logged. A topic tag helps track credits; it does not verify course content or board acceptance.",
      cite: "16 CCR \u00a7 1635(e)(3), Osteopathic Medical Board of California",
      url: "https://govt.westlaw.com/calregs/Document/I4500CE10638B11F0ADE8DF244CB90544",
      checkedOn: "2026-09-20", effectiveFrom: "2025-10-01",
      acceptedCategories: ["AOA Category 1-A", "AOA Category 1-B", "AOA Category 2-A", "AOA Category 2-B", "AMA PRA Category 1"],
      condition: {
        field: "California geriatric CME applies",
        question: "Are you a general internist or family physician AND are more than 25% of your patients aged 65 or older?",
        description: "Both conditions must be true: you are a general internist or family physician, and strictly more than 25% of your patients are aged 65 or older. Exactly 25% does not meet this threshold. Select your answer; the app does not infer it from your specialty, name, or CME records.",
    ...
    { topic: "Implicit Bias", hours: 0, informational: true, note: "AB 241 addresses CME course curriculum and accrediting entities, with exceptions for non-patient-care courses and out-of-state providers. It does not set a separate personal implicit-bias hour target or checklist. Review the course provider's documentation; an app topic tag does not verify its curriculum.", cite: "Cal. Bus. & Prof. Code \u00a7 2190.1(d) (AB 241); OMBC CME guidance", url: "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=BPC&sectionNum=2190.1", checkedOn: "2026-09-20" },
  ], notes: "One-time 12 hrs pain management/terminally ill (within 4 yrs of licensure or by 2nd renewal, whichever comes first; pathology and radiology exempt; a one-time 12-hr opiate-dependence course under BPC 2190.6 is an accepted alternative); min 1 hr Schedule II/opioid addiction every renewal cycle; implicit bias is a curriculum requirement on CME providers under AB 241, not physician hours; practice management, technology and billing/coding coursework plus medical school teaching capped at 30% of required hours (BPC 2190.15). 50/2yr + 20 AOA 1-A/1-B verified vs OMBC 2026-07", rollover: "No", moc: "No", source: "OMBC (Cal. B&P Code \u00a7 2454.5); \u00a7 2190.5 (one-time pain management); \u00a7 2190.15 (practice management cap); \u00a7 2190.1 (AB 241)", verified: "2026-08", sourceUrl: "https://www.ombc.ca.gov/licensees/cme.pdf" } },
  ...
  ], notes: "30 hrs accepted CME per 2-yr renewal. The 2-hr substance use disorder training requirement was REPEALED by SB 26-138 (signed 2026-06-02, eff. 2026-08-12); the Colorado Medical Board held its permanent rulemaking hearing on 2026-08-27 and the Board CME page no longer lists it. Do not complete it for renewal. Prorated for a first renewal under 24 months (22/15/10/5/0 hrs by time licensed). Board may audit up to 5% of physicians annually, oversampling non-board-certified. Board may waive first renewal if licensed within 12 months of finishing training. Verified vs DORA and CRS 12-240-130.5, 2026-08.", rollover: "No", moc: "Programs required to maintain national board certification count toward the 30 hrs", source: "HB 24-1153 (effective 2026-01-01)", verified: "2026-08", sourceUrl: "https://dpo.colorado.gov/Medical/CME", upcoming: [
  ...
  CT: { total: 50, cycle: 2, cat1min: 0, cat1note: "Not specified", topics: [
    { topic: "Infection Control", hours: 1.0, note: "infectious diseases including AIDS/HIV, first renewal in which CME is required, then once every 6 years", period: { years: 6 } },
    { topic: "Risk Management", hours: 1.0, note: "includes prescribing controlled substances and pain management, plus screening for inflammatory breast cancer, GI cancers and endometriosis; first renewal in which CME is required, then once every 6 years", period: { years: 6 } },
    { topic: "Sexual Assault", hours: 1.0, note: "first renewal in which CME is required, then once every 6 years", period: { years: 6 } },
    { topic: "Domestic Violence", hours: 1.0, note: "first renewal in which CME is required, then once every 6 years", period: { years: 6 } },
    { topic: "Cultural Competency", hours: 1.0, note: "includes systemic racism, explicit and implicit bias, racial disparities, and care of transgender and gender diverse persons; first renewal in which CME is required, then once every 6 years", period: { years: 6 } },
    { topic: "Behavioral Health", hours: 2.0, note: "mental health conditions common to veterans and their families (PTSD, suicide risk, depression, grief), or suicide prevention, or cognitive conditions (Alzheimer's, dementia, delirium); first renewal in which CME is required, then once every 6 years", period: { years: 6 } },
  ...
  DE: { total: 40, cycle: 2, cat1min: 40, cat1note: "All AMA or AOA Cat 1", topics: [
    { topic: "Controlled Substances", hours: 2.0, note: "2 hrs controlled substance prescribing, chronic pain, or related topics biennially, required of every Delaware controlled substance registration (CSR) holder", cite: "24 Del. Admin. Code Uniform Controlled Substances Act Regs. 3.1" },
    { topic: "Delaware Controlled Substance Law", hours: 1.0, note: "One-time 1 hr course on Delaware controlled substance law, within the first year of CSR registration. Was described only inside the biennial line, so it was never checked on its own.", period: "lifetime", cite: "24 Del. Admin. Code Uniform Controlled Substances Act Regs. 3.1" },
  ...
  FL: { md: { total: 40, cycle: 2, cat1min: 0, cat1note: "Cat 1 for required topics", topics: [
    { topic: "HIV/AIDS", hours: 1.0, note: "1 hr HIV/AIDS, one-time, due by first renewal", period: "lifetime" },
    { topic: "Medical Errors Prevention", hours: 2.0, note: "2 hrs medical errors" },
    { topic: "Domestic Violence", hours: 2.0, note: "2 hrs domestic violence (every 3rd renewal)", period: { years: 6 } },
    { topic: "Controlled Substances", hours: 2.0, note: "2 hrs prescribing controlled substances, each renewal, DEA registrants only" },
    { topic: "Human Trafficking", hours: 1.0, note: "1 hr human trafficking, one-time (s. 456.0341; deadline was Jan 1, 2021; counts toward the 40)", period: "lifetime" },
    ...
    { topic: "HIV/AIDS", hours: 1.0, note: "1 hr HIV/AIDS, one-time, no later than first renewal", period: "lifetime" },
    { topic: "Medical Errors Prevention", hours: 2.0, note: "2 hrs medical errors" },
    { topic: "Controlled Substances", hours: 2.0, note: "2 hrs prescribing controlled substances, each renewal, DEA registrants only" },
    { topic: "Florida Laws and Rules", hours: 1.0, note: "1 hr Florida Laws and Rules/Professional and Medical Ethics, each renewal" },
    { topic: "Domestic Violence", hours: 2.0, note: "2 hrs domestic violence, every third biennial renewal", period: { years: 6 } },
    { topic: "Human Trafficking", hours: 1.0, note: "1 hr human trafficking, one-time (s. 456.0341)", period: "lifetime" },
  ...
  GA: { total: 40, cycle: 2, cat1min: 0, cat1note: "AMA Cat 1, AOA Cat 1, AAFP, ACOG, or ACEP Cat 1", topics: [
    { topic: "Opioid Prescribing", hours: 3.0, note: "3 hrs Cat 1 controlled substance prescribing, one-time (active DEA holders who prescribe controlled substances; not required if meeting the 20 hr pain mgmt rule)", period: "lifetime" },
    { topic: "Sexual Harassment Prevention", hours: 2.0, note: "one-time 2 hr professional boundaries/sexual misconduct course", period: "lifetime" },
  ...
  IA: { total: 40, cycle: 2, cat1min: 40, cat1note: "All 40 hours must be Category 1 (or board-approved equivalent such as ABMS/AOA certification)", topics: [
    { topic: "Child Abuse Recognition", hours: 2.0, note: "2 hrs child abuse identification and reporting every 3 yrs (licensees who regularly provide primary health care to children, incl. EM, FM, GP, peds, psychiatry)", period: { years: 3 }, cite: "Iowa Admin. Code r. 481-654.3(1)(c)(1)" },
    { topic: "Dependent Adult Abuse", hours: 2.0, note: "2 hrs dependent adult abuse identification and reporting every 3 yrs (adult primary care providers)", period: { years: 3 }, cite: "Iowa Admin. Code r. 481-654.3(1)(c)(2)" },
    { topic: "Opioid Prescribing", hours: 2.0, note: "2 hrs Category 1 credit on CDC guidelines for opioid prescribing every 5 yrs (licensees who prescribed opioids in the prior license period)", period: { years: 5 }, cite: "Iowa Admin. Code r. 481-654.3(1)(d)(1)" },
    { topic: "End-of-Life Care", hours: 2.0, note: "2 hrs Category 1 credit for end-of-life care every 5 yrs (if regularly caring for actively dying patients)", period: { years: 5 }, cite: "Iowa Admin. Code r. 481-654.3(1)(e)" },
  ...
  IL: { total: 150, cycle: 3, cat1min: 60, cat1note: "60 hrs Cat 1", topics: [
    { topic: "Sexual Harassment Prevention", hours: 1.0, note: "1 hr sexual harassment prevention (each cycle)", cite: "68 Ill. Admin. Code \u00a7 1285.110" },
    { topic: "Implicit Bias", hours: 1.0, note: "1 hr implicit bias (each cycle)", cite: "68 Ill. Admin. Code \u00a7 1285.110" },
    { topic: "Opioid Prescribing", hours: 1.0, note: "1 hr safe opioid prescribing each renewal cycle, only if you hold an Illinois controlled substance license", cite: "720 ILCS 570/315.5" },
    { topic: "Cultural Competency", hours: 1.0, note: "1 hr cultural competency, before the first renewal that requires CE then retaken once every 6 years (renewals on or after Jan 1, 2025)", period: { years: 6 }, cite: "IDFPR Continuing Education requirements" },
    { topic: "Alzheimer's Disease and Other Dementias", hours: 1.0, note: "1 hr Alzheimer's disease and other dementias, before the first renewal that requires CE then once every 6 years (renewals on or after Jan 1, 2025)", period: { years: 6 }, cite: "IDFPR Continuing Education requirements" },
    { topic: "Mandated Reporter Training", hours: 1.0, note: "1 hr mandated reporter training, at least once every 6 years, attested at each renewal. Was described in the state notes but had no line of its own, so it was never checked.", period: { years: 6 }, cite: "IDFPR Continuing Education requirements" },
  ...
  KY: { total: 60, cycle: 3, cat1min: 30, cat1note: "30 hrs Cat 1", topics: [
    ...
    { topic: "Domestic Violence", hours: 3.0, note: "3 hrs domestic violence, one-time, within 3 yrs of initial licensure. Primary care physicians licensed after July 1, 1996: family/general practice, pediatrics, internal medicine, emergency medicine, OB/GYN, preventive medicine/public health.", period: "lifetime", cite: "Kentucky Board of Medical Licensure, CME requirements" },
    { topic: "Pediatric Abusive Head Trauma", hours: 1.0, note: "1 hr pediatric abusive head trauma, one-time, within 5 yrs of licensure (pediatrics, radiology, family medicine, emergency medicine, urgent care)", period: "lifetime", cite: "Kentucky Board of Medical Licensure, CME requirements" },
  ...
  MA: { total: 50, cycle: 2, cat1min: 0, cat1note: "Cat 1 or 2 (ACCME/AOA/AAFP accredited)", topics: [
    ...
    { topic: "End-of-Life Care", hours: 2.0, note: "2 hrs end-of-life issues, one-time", period: "lifetime", cite: "BORIM Policy 17-05; Final Amended CME Guidelines" },
    { topic: "Electronic Health Records", hours: 3.0, note: "3 hrs EHR proficiency, may count toward risk management. Published BORIM summaries disagree on whether this is one-time or per cycle, so it is counted every cycle here, the stricter reading, until Policy 17-05 is read directly.", cite: "BORIM Policy 17-05 (periodicity unresolved)" },
    { topic: "Implicit Bias", hours: 2.0, note: "2 hrs implicit bias, one-time (adopted effective June 1, 2022, at initial licensure or renewal if not previously completed); counts toward risk management", period: "lifetime", cite: "BORIM Policy 2021-04, one-time 2.00 credits (eff. 2022-06-01)", url: "https://www.mass.gov/info-details/continuing-medical-education-on-implicit-bias-in-healthcare" },
    { topic: "Child Abuse Recognition", hours: 0, note: "Child abuse and neglect training, one-time, no hour minimum", period: "lifetime", cite: "BORIM Policy 17-05; Final Amended CME Guidelines" },
    { topic: "Domestic Violence", hours: 0, note: "Domestic and sexual violence training, DPH-approved course, one-time, no hour minimum", period: "lifetime", cite: "BORIM Policy 17-05; Final Amended CME Guidelines" },
    { topic: "Geriatric Medicine", hours: 1.0, note: "1 hr Alzheimer's/dementia, one-time, if serving adult populations", period: "lifetime", cite: "BORIM Policy 17-05; Final Amended CME Guidelines" },
  ...
  MD: { total: 50, cycle: 2, cat1min: 25, cat1note: "25 hrs Cat 1", topics: [
    { topic: "Controlled Substances", hours: 2.0, note: "2 hrs CE on prescribing or dispensing controlled dangerous substances, one-time, required by MDH OCSA for CDS registration (new or first renewal on or after Oct 1, 2018), not a Board of Physicians renewal requirement", period: "lifetime", cite: "MDH Office of Controlled Substances Administration; MBP 2026 renewal information" },
    { topic: "Implicit Bias", hours: 0, note: "One-time implicit bias training, ACCME-accredited or board-recognized. The Board states that licensees who completed an implicit bias program for a prior renewal are not required to complete another.", period: "lifetime", cite: "Md. Board of Physicians 2026 renewal information" },
    { topic: "Structural Racism", hours: 0, note: "One-time structural racism training, separate from implicit bias, for licensees renewing for the first time after April 1, 2026. ACCME-accredited or board-recognized program. Was bundled into the implicit bias line, so a physician who had done implicit bias but not this showed compliant.", period: "lifetime", cite: "Md. Health Occ. \u00a7 1-225; MBP 2026 renewal information" },
  ...
  ME: { md: { total: 40, cycle: 2, cat1min: 40, cat1note: "All Cat 1", topics: [
    { topic: "Opioid Prescribing", hours: 3.0, note: "3 hrs opioid prescribing every 2 yrs", cite: "32 M.R.S. \u00a7 3300-F(4)", url: "https://legislature.maine.gov/statutes/32/title32sec3300-F.html" },
  ], notes: "3 hrs opioid prescribing every 2 yrs", rollover: "No", moc: "Yes: current ABMS certification with MOC counts as the 40 Cat 1 hrs (lifetime certs excluded); 3 hrs opioid CME still required", source: "ME BLM Rules ch. 1 s. 11 (amended eff. Feb 3, 2026); 32 M.R.S. § 3300-F(4); ME BLM CME Information", verified: "2026-08", sourceUrl: "https://www.maine.gov/md/licensure/license-faq" }, do: { total: 100, cycle: 2, cat1min: 0, cat1note: "40 hrs osteopathic medical ed; primary care: all AOA Cat 1", topics: [
    { topic: "Opioid Prescribing", hours: 3.0, note: "3 hrs opioid prescribing every 2 yrs, applies to DOs who prescribe opioids", cite: "32 M.R.S. \u00a7 2600-C" },
  ...
  MI: { md: { total: 150, cycle: 3, cat1min: 75, cat1note: "75 hrs Cat 1", topics: [
    ...
    { topic: "Implicit Bias", hours: 3.0, note: "1 hr of implicit bias training for EACH YEAR of the license cycle. Michigan physicians renew every 3 years, so a renewal owes 3 hrs. Hours earned in one cycle may not be carried forward. Initial licensure is a separate 2 hrs within the 5 years preceding issuance.", cite: "Mich. Admin. Code R 338.7004", url: "https://ars.apps.lara.state.mi.us/AdminCode/DownloadAdminCodeFile?FileName=R+338.7001+to+R+338.7005.pdf&ReturnHTML=True" },
    { topic: "Human Trafficking", hours: 0, note: "One-time human trafficking training. LARA treats it as a one-time training that is not part of the continuing education requirement, though a CE activity may satisfy it.", period: "lifetime", cite: "LARA human trafficking training requirement (one-time)" },
    { topic: "Opioid Awareness", hours: 0, note: "One-time opioids and controlled substance awareness training, controlled substance licensees only", period: "lifetime", cite: "Mich. Admin. Code R 338.3135" },
  ], notes: "1 hr medical ethics; 3 hrs pain/symptom management; 3 hrs implicit bias per 3-yr cycle (1 hr for each year of the cycle, R 338.7004; no carry-forward); one-time human trafficking; one-time opioid/controlled substance awareness training (controlled substance licensees)", rollover: "No", moc: "30 hrs for ABMS MOC activities", source: "LARA MD Licensing Guide", verified: "2026-08", sourceUrl: "https://www.michigan.gov/lara/bureau-list/bpl/health/hp-lic-health-prof/medical/medical-doctor-licensing-guides-and-faqs/md-licensing-guide-and-faqs" }, do: { total: 150, cycle: 3, cat1min: 60, cat1note: "60 hrs Cat 1, at least 40 of them AOA or MOA approved", topics: [
    { topic: "Ethics", hours: 1.0, note: "1 hr medical ethics" },
    { topic: "Controlled Substances", hours: 3.0, note: "3 hrs pain/symptom management (1 hr controlled substances)" },
    { topic: "Implicit Bias", hours: 3.0, note: "1 hr of implicit bias training for EACH YEAR of the license cycle. Michigan physicians renew every 3 years, so a renewal owes 3 hrs. Hours earned in one cycle may not be carried forward. Initial licensure is a separate 2 hrs within the 5 years preceding issuance.", cite: "Mich. Admin. Code R 338.7004", url: "https://ars.apps.lara.state.mi.us/AdminCode/DownloadAdminCodeFile?FileName=R+338.7001+to+R+338.7005.pdf&ReturnHTML=True" },
    { topic: "Human Trafficking", hours: 0, note: "One-time human trafficking training. LARA treats it as a one-time training that is not part of the continuing education requirement, though a CE activity may satisfy it.", period: "lifetime", cite: "LARA human trafficking training requirement (one-time)" },
    { topic: "Opioid Awareness", hours: 0, note: "One-time opioids and controlled substance awareness training, controlled substance licensees only", period: "lifetime", cite: "Mich. Admin. Code R 338.3135" },
  ], notes: "1 hr medical ethics; 3 hrs pain/symptom management (1 hr controlled substances); 3 hrs implicit bias per 3-yr cycle (1 hr for each year of the cycle, R 338.7004; no carry-forward); one-time human trafficking; one-time opioid/controlled substance awareness training (controlled substance licensees)", rollover: "No", moc: "No", source: "LARA DO Licensing Guide", verified: "2026-08", sourceUrl: "https://ars.apps.lara.state.mi.us/AdminCode/DownloadAdminCodeFile?FileName=R+338.111+to+R+338.143.pdf&ReturnHTML=True" } },
  ...
  MS: { total: 40, cycle: 2, cat1min: 40, cat1note: "All Cat 1", topics: [
    { topic: "Controlled Substances", hours: 8.0, note: "One-time 8-hour DEA training on opioid or other substance use disorders for licensees holding an active DEA registration; the 5-hour per-cycle prescribing requirement was removed from Rule 2.1. This is the same one-time federal training the MATE Act line tracks, not a second 8 hours.", period: "lifetime", cite: "30 Miss. Admin. Code Pt. 2610 Ch. 2, R. 2.1; Controlled Substances Act \u00a7 303" },
  ...
  NV: { md: { total: 40, cycle: 2, cat1min: 40, cat1note: "All Cat 1", topics: [
    ...
    { topic: "Suicide Prevention", hours: 2.0, note: "2 hrs suicide detection, intervention and prevention within 2 yrs of initial licensure, then once every 4 yrs", period: { years: 4 }, cite: "Nevada State Board of Medical Examiners, CME requirements" },
    { topic: "Cultural Competency", hours: 2.0, note: "2 hrs cultural competency and DEI every 2 yrs, psychiatrists only", cite: "NRS 630.2535; Nevada State Board of Medical Examiners CME requirements" },
    { topic: "HIV Stigma", hours: 2.0, note: "2 hrs stigma, discrimination and unrecognized bias toward persons with or at high risk of HIV, one-time, within 2 yrs after beginning to provide or supervise such care; MDs providing or supervising emergency medical services in a hospital or primary care", period: "lifetime", cite: "Nevada State Board of Medical Examiners, CME requirements" },
    { topic: "Substance Use Disorders", hours: 2.0, note: "2 hrs Screening, Brief Intervention and Referral to Treatment (SBIRT) within 2 yrs of initial licensure, one time only. Was described in the state notes but had no line of its own, so it was never checked.", period: "lifetime", cite: "Nevada State Board of Medical Examiners, CME requirements" },
    ...
    { topic: "Suicide Prevention", hours: 2.0, note: "2 hrs evidence-based suicide prevention and awareness within 2 yrs of licensure, then 2 hrs every 4 yrs", period: { years: 4 }, cite: "Nevada State Board of Osteopathic Medicine, CME requirements" },
    { topic: "Pain Management", hours: 2.0, note: "2 hrs ethics, pain management or addiction care, even-numbered years only, so every other year", period: { years: 2 }, cite: "NRS 633.471(7)" },
    { topic: "Cultural Competency", hours: 2.0, note: "2 hrs cultural competency and DEI, biennially, psychiatrists and their supervised PAs only", period: { years: 2 }, cite: "NRS 633.471(12)" },
  ...
  NY: { total: 0, cycle: 0, cat1min: 0, cat1note: "None (general)", topics: [
    { topic: "Pain Management", hours: 3.0, note: "3 hrs pain management, palliative care and addiction, once every 3 years, DEA-registered prescribers", period: { years: 3 }, cite: "N.Y. Pub. Health Law \u00a7 3309-a", url: "https://www.health.ny.gov/professionals/narcotic/mandatory_prescriber_education/" },
    { topic: "Child Abuse Recognition", hours: 2.0, note: "2 hrs child abuse and maltreatment identification and reporting, required of every applicant for licensure or a limited permit, so a one-time pre-licensure requirement rather than recurring CME. Existing mandated reporters must complete the updated curriculum by November 17, 2026.", period: "lifetime", cite: "NYSED physician license requirements (pre-licensure coursework)", url: "https://www.op.nysed.gov/professions/physicians/license-requirements" },
    { topic: "Infection Control", hours: 0, note: "Infection control and barrier precautions coursework, once every 4 years", period: { years: 4 }, cite: "NYSED physician license requirements", url: "https://www.op.nysed.gov/professions/physicians/license-requirements" },
  ...
  OK: { md: { total: 60, cycle: 3, cat1min: 60, cat1note: "All Cat 1", topics: [
    ...
    { topic: "Controlled Substances", hours: 1.0, note: "1 hr/yr controlled substance prescribing (pain management, opioid use, or addiction) for DEA/OBNDD holders", cite: "OK Admin. Code 510:10-3-8" },
  ...
  PA: { md: { total: 100, cycle: 2, cat1min: 20, cat1note: "20 hrs Cat 1", topics: [
    ...
    { topic: "Organ and Tissue Donation", hours: 2.0, note: "2 hrs organ and tissue donation and recovery process, one time within 5 years of initial licensure or of renewal/reactivation, Cat 1 or 2, counts toward the 100. The rule says so verbatim: this is a one-time requirement.", period: "lifetime", cite: "49 Pa. Code \u00a7 16.19 (one-time requirement)" },
    ...
    { topic: "Organ and Tissue Donation", hours: 2.0, note: "2 hrs organ and tissue donation and recovery process, one time within 5 years of initial licensure or of renewal, AOA Cat 1 or 2, counts toward the 100. Chapter 25 mirrors the Board of Medicine rule at 49 Pa. Code 16.19, which states the one-time wording verbatim.", period: "lifetime", cite: "49 Pa. Code \u00a7 25.271 (mirrors \u00a7 16.19)" },
  ...
  RI: { total: 40, cycle: 2, cat1min: 40, cat1note: "All AMA Cat 1 or AOA Cat 1A", topics: [
    { topic: "Geriatric Medicine", hours: 1.0, note: "1 hr Alzheimer's/cognitive impairment, one-time over a career", period: "lifetime", cite: "R.I. Gen. Laws \u00a7 23-1.7-5" },
  ...
  TX: { total: 48, cycle: 2, cat1min: 24, cat1note: "24 hrs AMA Cat 1 or AOA Cat 1A", topics: [
    { topic: "Ethics", hours: 2.0, note: "2 hrs medical ethics/professional responsibility (Cat 1/1A), every renewal, all physicians", cite: "22 Tex. Admin. Code \u00a7 161.35" },
    { topic: "Human Trafficking", hours: 1.0, note: "HHSC-approved human trafficking prevention course, direct patient care physicians, before first renewal then every 3rd renewal (every 6 yrs); TMB page states at least 1 hr; may count toward ethics; not covered by board cert/MOC", period: { years: 6 }, cite: "22 Tex. Admin. Code \u00a7 161.35 (TMB CE requirements)" },
    { topic: "Opioid Prescribing", hours: 2.0, note: "2 hrs opioid prescribing: within one year of license issuance and again at the second renewal, then no less than 2 hrs every 8 yrs", period: { years: 8 }, cite: "22 Tex. Admin. Code \u00a7 161.35 (TMB CE requirements)" },
    { topic: "Pain Management", hours: 10.0, note: "10 hrs pain management per 2-yr renewal cycle, for physicians who own or operate a pain management clinic. 22 TAC ch. 195 was repealed and reorganized into ch. 172; TMB states the requirement biennially under 22 TAC 172.3.", cite: "22 TAC \u00a7 172.3", url: "https://www.tmb.texas.gov/apply-renew/other-permits-and-licenses/pain-management-clinics/continuing-education-pain-management-clinics" },
    { topic: "Life of the Mother Act", hours: 0, note: "One-time TMB Life of the Mother Act course (SB 31), physicians providing obstetric care (OB/GYN, MFM, family medicine, emergency medicine and related); counts only as ethics credit", period: "lifetime", cite: "SB 31 (89th Leg.); TMB continuing education requirements" },
  ], notes: "2 hrs medical ethics/professional responsibility (all physicians); human trafficking prevention course (direct patient care, before first renewal then every 6 yrs); 2 hrs opioid prescribing (first 2 renewals, then every 8 yrs); 10 hrs pain mgmt per 2-yr period (pain clinic medical directors); one-time Life of the Mother Act course (obstetric care); nutrition training", rollover: "Yes: up to 48 excess credits carry forward to the next registration period only; required ethics, opioid, and human trafficking hours cannot be carried forward", moc: "Board cert/recert within 36 months before renewal presumes compliance for one renewal; current ABMS MOC or AOA OCC also accepted; covers ethics, does not cover human trafficking; opioid depends on specialty board", source: "Tex. Admin. Code tit. 22, \u00a7 161.35", verified: "2026-08", sourceUrl: "https://www.tmb.texas.gov/apply-renew/physician/continuing-education-requirements-for-physicians", upcoming: [
  ...
  WA: { md: { total: 200, cycle: 4, cat1min: 200, cat1note: "All 200 may be Cat 1; max 80 each of Cat 2-5", topics: [
    { topic: "Suicide Prevention", hours: 6.0, note: "One-time 6 hrs suicide assessment/treatment", period: "lifetime" },
    { topic: "Opioid Prescribing", hours: 1.0, note: "one-time 1 hr opioid prescribing", period: "lifetime" },
    { topic: "Cultural Competency", hours: 2.0, note: "2 hrs health equity every 4 years (WAC 246-919-445, eff 1/1/2024)", period: { years: 4 } },
    ...
    { topic: "Suicide Prevention", hours: 6.0, note: "One-time 6 hrs suicide assessment/treatment", period: "lifetime" },
    { topic: "Opioid Prescribing", hours: 1.0, note: "one-time 1 hr opioid prescribing", period: "lifetime" },
    { topic: "Cultural Competency", hours: 2.0, note: "2 hrs health equity every 4 years (not per 3-yr cycle), WAC 246-853-075", period: { years: 4 } },
  ...
  WY: { total: 60, cycle: 3, cat1min: 60, cat1note: "All Cat 1 or 2 (AMA/AOA)", topics: [
    { topic: "Controlled Substances", hours: 1.0, note: "1 hr responsible prescribing of controlled substances or SUD treatment every 2 yrs (CSR holders). Wyoming's general CME cycle is 3 years, so this is counted on its own 2-year clock, not the 3-year one.", period: { years: 2 }, cite: "Wyo. Stat. \u00a7 33-26-202(b)(xiv)" },
  ], notes: "1 hr responsible prescribing of controlled substances or SUD treatment every 2 yrs (CSR holders)", rollover: "No", moc: "AMA PRA; ABMS cert accepted as equivalent", source: "WY Board of Medicine Rules Ch. 3, \u00a7 7", verified: "2026-08", sourceUrl: "https://wyomedboard.wyo.gov/resources/rules-and-regulations" },
};
