...
export const STATE_REQS = {
  ...
  CA: { md: { total: 50, cycle: 2, cat1min: 50, cat1note: "All Cat 1 approved", topics: [
    ...
    { topic: "Geriatric Medicine", hours: 0, note: "General internists and family physicians whose patient population is more than 25% aged 65 or older must complete at least 20% of their mandatory CME in geriatric medicine; the board publishes no fixed hour count", cite: "Medical Board of California, Continuing Medical Education" },
    { topic: "Implicit Bias", hours: 0, note: "AB 241 is a curriculum requirement on CME course providers and accrediting entities, not an hour requirement on the physician: courses must contain implicit bias content. There is no number of implicit bias hours to log and no separate certificate to produce at audit.", cite: "Cal. Bus. & Prof. Code \u00a7 2190.1 (AB 241, Stats. 2019, Ch. 417)" },
    ...
    { topic: "Implicit Bias", hours: 0, note: "AB 241 is a curriculum requirement on CME providers and accrediting entities, not an hour requirement on the physician. OMBC states it plainly: CME accrediting entities have responsibility to create compliant curriculum.", cite: "Cal. Bus. & Prof. Code \u00a7 2190.1 (AB 241, Stats. 2019, Ch. 417)" },
