...
<body>
  ...
  <div class="wrap">
    ...
    <main id="main">
      ...
      <section class="next" aria-labelledby="next-heading"><p><!-- public-launch:early-release -->credentialdomd is an early release. Some workflows are less polished, and the app will continue to evolve.<!-- /public-launch:early-release --></p><p><!-- public-launch:participation -->Founding members help shape what comes next. Use Vera to get help with the app and share feedback, and use in-app support tickets to report problems or request improvements. Review a ticket before sending it.<!-- /public-launch:participation --></p><h2 id="next-heading">Organize your own records</h2><p><!-- public-launch:availability -->credentialdomd membership opens by invitation. Billing is not open. A card is required at future paid checkout. Join the waitlist, or open the app if you already have access.<!-- /public-launch:availability --></p><div class="actions"><!-- public-launch:cta --><a class="button" href="/#join">Request early access</a><!-- /public-launch:cta --><a href="/app/">Open the app</a></div></section>
    </main>
