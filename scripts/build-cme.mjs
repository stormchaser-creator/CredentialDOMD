...
<section id="next-step" class="next-step"><div><p><!-- public-launch:early-release -->CredentialDOMD is an early release. Some workflows are less polished, and the app will continue to evolve.<!-- /public-launch:early-release --></p><p><!-- public-launch:participation -->Founding members help shape what comes next. In the app, ask VERA for help and use support tickets to report problems or suggest improvements.<!-- /public-launch:participation --></p><p class="eyebrow">From learning to a clear record</p><h2>Keep the evidence with the deadline.</h2><p>Use CredentialDOMD to organize certificates and review your saved CME. Confirm acceptance and unresolved exceptions with the receiving board.</p></div><div class="actions"><a class="button" href="/app/">Open CredentialDOMD</a><!-- public-launch:cta --><a href="/#join">Request beta access →</a><!-- /public-launch:cta --><a href="/help/#get-help">Get product support</a></div></section>
