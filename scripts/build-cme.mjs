...
</main><footer><p>CredentialDoMD · Free invite-only beta. Billing is off.</p><nav aria-label="Footer navigation"><a href="/">Home</a><a href="/states/">License guides</a><a href="/help/">Help & videos</a><a href="/privacy">Privacy</a><a href="/terms">Terms</a><a href="/security">Security & data handling</a></nav></footer></div></body></html>\n`;
}
