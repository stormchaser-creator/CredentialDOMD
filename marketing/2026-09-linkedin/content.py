...
ABOUT = """I am a practicing neurosurgeon. I hold more than one state license, a DEA registration, board certification and hospital privileges, and every one of them runs on a different clock.
...
POSTS = [
 dict(week="Week 1", when="Post this week. The rule took effect September 1 and the next Texas expiration date is November 30.",
...
I built this. It is called CredentialDOMD. Founding membership is $99 a year for the first 100 paid members, with a no-hassle 100% money-back guarantee.""",
 ...
 dict(week="Week 3", when="Florida online renewal opens about 90 days before January 31, which is early November. This lands just ahead of it.",
  ...
  flag="The DO paragraph (March 31 of even years, $405, 1-hour Laws and Rules) comes from the August multi-source check, not from today's live read. The MD figures were re-read live today.",
