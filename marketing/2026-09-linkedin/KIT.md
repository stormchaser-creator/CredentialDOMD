...
Neurosurgeon, DO | Founder of CredentialDOMD | I publish the medical license renewal rules for all 50 states and DC, and built the tracker I wanted for my own licenses, DEA, boards and CME

## About

I am a practicing neurosurgeon. I hold more than one state license, a DEA registration, board certification and hospital privileges, and every one of them runs on a different clock.

California anchors renewal to the month your license was issued. Colorado expires every physician on April 30 of odd-numbered years. Texas assigns one of four fixed dates and picks the year by whether your license number is odd or even. Maine goes by whether you were born in an odd or an even year, and sends DOs to a different board with a different CME requirement.
...
I also published what I learned: a renewal guide for every state and DC, each one citing the board's own pages. Free to read at credentialdomd.com/states

What I post here: one renewal rule a week that physicians get caught by, with the source.

It is an early release, and founding members help shape what comes next. Founding membership is $99 a year for the first 100 paid members, and that rate stays locked for life while membership remains active. No-hassle 100% money-back guarantee: a full refund of your most recent annual payment, at any time.

## Experience entry

Title: Founder
Company: CredentialDOMD
Description: I built the credential tracker I wanted as a multi-state physician: licenses, DEA, board certification, privileges and CME in one place, with each state's renewal rules built in. I also publish free, sourced renewal guides for all 50 states and DC at credentialdomd.com/states

## Week 1: Texas: CE Broker hard stop

_Post this week. The rule took effect September 1 and the next Texas expiration date is November 30._

```
Texas physicians: as of September 1, you cannot renew your license until your CME is in CE Broker.
...
Online renewal opens 60 to 90 days before expiration. A half-finished application is saved for 15 days. After that you start over.
...
I am a practicing neurosurgeon. I built CredentialDOMD and use it for my own credentials. Founding membership is $99 a year for the first 100 paid members, with a no-hassle 100% money-back guarantee.
```

| Claim | Checked against | Link |
|---|---|---|
| CE Broker required from September 1, 2026; basic account free; cannot renew if TMB cannot verify | TMB Continuing Education Tracking page, read live 2026-09-21 | https://www.tmb.texas.gov/resources/for-applicants-and-licensees/continuing-education-tracking |
| Four dates; even/odd license numbers; 60 to 90 days; 15-day save; 30-day grace; $75 then $150 after 90 days; cancelled at one year | TMB Physician Renewal page, read live 2026-09-21, every figure quoted verbatim | https://www.tmb.texas.gov/apply-renew/physician/physician-renewal |
...
## Week 2: Why a neurosurgeon built a license tracker

_The founder post. Goes second so that people who check your profile after the Texas post find a reason to follow._

**Before posting:** Confirm the count before posting. The draft says four licenses and names four anchor types (California, Colorado, North Dakota, Maine). If you hold a different number, change it, or write "my licenses".
...
So I made the thing I wanted. It holds the licenses, the DEA record, the board requirements and the per-state CME rules in one place, and I use it on my own credentials.
...
| Claim | Checked against | Link |
|---|---|---|
| California, Colorado, North Dakota and Maine anchor rules; Maine DO board and 100 vs 40 hours | landing/states/states-data.json, fact-checked field by field in marketing/2026-08-refresh/linkedin-01-founder-arc.md. Maine is multi-source verified. | https://credentialdomd.com/states/maine |
| $99 founding rate and the money-back guarantee | Live wording on credentialdomd.com and its Terms, read 2026-09-21: "No-hassle 100% money-back guarantee: a full refund of your most recent annual payment, at any time." | https://credentialdomd.com/ |

## Week 3: Florida: no grace period, $355 becomes $705 overnight

_Florida online renewal opens about 90 days before January 31, which is early November. This lands just ahead of it._

**Before posting:** The DO paragraph (March 31 of even years, $405, 1-hour Laws and Rules) comes from the August multi-source check, not from today's live read. The MD figures were re-read live today.

```
Florida MDs in Group 2: your license expires January 31, 2027, and Florida has no grace period.
...
| Claim | Checked against | Link |
|---|---|---|
| $355, $705, $1,060; Group 1 even years, Group 2 odd years; delinquent status; null and void; CE Broker | Florida Board of Medicine MD renewal page, read live 2026-09-21, figures quoted verbatim | https://flboardofmedicine.gov/medical-doctor-renewal/ |
| DO date, fee and Laws and Rules hour | Florida Board of Osteopathic Medicine renewal and fees pages, verified 2026-08 | https://floridasosteopathicmedicine.gov/renewals/osteopathic-physician-renewal/ |

## Week 4: Colorado: the first renewal with mandatory CME

_Colorado's April 30, 2027 renewal is the first one with mandatory CME. Seven months of lead time is the point of the post._
...
| Claim | Checked against | Link |
|---|---|---|
| Every Colorado claim | Eleven-point fact check against states-data.json and the statute, in marketing/2026-08-refresh/linkedin-03-state-guide.md. Colorado is multi-source verified. | https://credentialdomd.com/states/colorado |
